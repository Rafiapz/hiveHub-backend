...
const verify = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((userData === null || userData === void 0 ? void 0 : userData.otp) !== data.otp) {
            throw new Error('Incorrect otp');
        }
        const user = yield models_1.User.findOneAndUpdate({ email: data.email, otp: data.otp }, { isVerified: true, otp: '' });
        if (!user) {
