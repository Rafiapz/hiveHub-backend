    ...
    return (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (req === null || req === void 0 ? void 0 : req.query.coverPhoto) {
                data.coverPhoto = `${process === null || process === void 0 ? void 0 : process.env.BACK_END_URL}/api/image/posts/${(_a = req === null || req === void 0 ? void 0 : req.file) === null || _a === void 0 ? void 0 : _a.filename}`;
            }
            else if ((_b = req === null || req === void 0 ? void 0 : req.query) === null || _b === void 0 ? void 0 : _b.profilePhoto) {
                data.profilePhoto = `${process === null || process === void 0 ? void 0 : process.env.BACK_END_URL}/api/image/posts/${(_c = req === null || req === void 0 ? void 0 : req.file) === null || _c === void 0 ? void 0 : _c.filename}`;
            }
            ...
            if (data === null || data === void 0 ? void 0 : data.email) {
                ...
                if (!otpDetails) {
                    ...
                    yield updateUserByIdUseCase(dependencies).execute(id, { otp: otpDetails });
