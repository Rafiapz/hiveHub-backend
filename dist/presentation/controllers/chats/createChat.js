    ...
    return (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (((_e = req === null || req === void 0 ? void 0 : req.file) === null || _e === void 0 ? void 0 : _e.filename) && params === 'image') {
                const path = `${process === null || process === void 0 ? void 0 : process.env.BACK_END_URL}/api/image/posts/${(_f = req === null || req === void 0 ? void 0 : req.file) === null || _f === void 0 ? void 0 : _f.filename}`;
                data.image = path;
            }
            if (params === 'video') {
                const path = `${process === null || process === void 0 ? void 0 : process.env.BACK_END_URL}/api/image/posts/${(_g = req === null || req === void 0 ? void 0 : req.body) === null || _g === void 0 ? void 0 : _g.fileName}`;
                data.video = path;
            }
