...
const createStoryController = (dependencies) => {
    ...
    return (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            const path = `${process === null || process === void 0 ? void 0 : process.env.BACK_END_URL}/api/image/posts/${(_a = req === null || req === void 0 ? void 0 : req.file) === null || _a === void 0 ? void 0 : _a.filename}`;
            const data = {
